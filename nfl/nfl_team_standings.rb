...
nfl_team_standings << ["season", "team_id", "team_name", "status", "team_url", "wins", "losses", "ties", "win_percentage", "points_for", "points_against", "net_points", "touchdowns", "home_record", "road_record", "division_record", "division_win_percentage", "conference_record", "conference_win_percentage", "nonconference_record","winning_streak","last_5_record"]
